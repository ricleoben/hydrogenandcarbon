...
const mosaContent = {
  en: {
    ...
    photos: [
      ...
      {
        src: "/mosa-beekeeping-hives.jpg",
        alt: "Beekeeper checking a row of beehives at the research centre",
        title: "Biodiversity in practice",
        text: "The beehives create a direct connection between biodiversity, local ecosystems, and hands-on learning.",
      },
      {
        src: "/mosa-beekeeping-teamwork.jpg",
        alt: "Two team members working together on an open beehive",
        title: "Caring for the colony",
        text: "Regular hive work turns ecological knowledge into practical experience and shared responsibility.",
      },
      {
        src: "/mosa-beekeeping-inspection.jpg",
        alt: "Beekeeper inspecting a hive with Leoben visible in the background",
        title: "Urban nature up close",
        text: "The apiary brings pollinators and biodiversity into the heart of the research centre's surroundings.",
      },
      {
        src: "/mosa-beekeeping-close-up.jpg",
        alt: "Two beekeepers closely inspecting frames inside a hive",
        title: "Learning from the hive",
        text: "Close observation reveals how bee colonies organise, adapt, and contribute to resilient ecosystems.",
      },
      {
        src: "/associations1.jpeg",
        alt: "Association members at a MOSA outdoor session",
        title: "Associations on the Energy Path",
        text: "Clubs and member groups explore sustainability topics through guided outdoor stations.",
      },
      {
        src: "/associations2.jpeg",
        alt: "MOSA workshop with association participants",
        title: "Hands-on learning for member groups",
        text: "Youth clubs, NGOs, and civic associations take part in experiments and field activities together.",
      },
      {
        src: "/associations4.jpeg",
        alt: "Association group at a MOSA station",
        title: "Shared learning experiences",
        text: "Organisers and members connect association goals with ongoing research at the centre.",
      },
    ],
  },
  de: {
    ...
    photos: [
      ...
      {
        src: "/mosa-beekeeping-hives.jpg",
        alt: "Imker bei der Kontrolle einer Reihe von Bienenstöcken am Forschungszentrum",
        title: "Biodiversität in der Praxis",
        text: "Die Bienenstöcke verbinden Biodiversität, lokale Ökosysteme und praxisnahes Lernen unmittelbar miteinander.",
      },
      {
        src: "/mosa-beekeeping-teamwork.jpg",
        alt: "Zwei Teammitglieder arbeiten gemeinsam an einem geöffneten Bienenstock",
        title: "Für das Bienenvolk sorgen",
        text: "Die regelmäßige Arbeit am Bienenstock macht ökologisches Wissen praktisch erfahrbar und fördert gemeinsame Verantwortung.",
      },
      {
        src: "/mosa-beekeeping-inspection.jpg",
        alt: "Imker bei der Kontrolle eines Bienenstocks mit Leoben im Hintergrund",
        title: "Stadtnatur aus nächster Nähe",
        text: "Der Bienenstand bringt Bestäuber und Biodiversität mitten in das Umfeld des Forschungszentrums.",
      },
      {
        src: "/mosa-beekeeping-close-up.jpg",
        alt: "Zwei Imker untersuchen Waben in einem geöffneten Bienenstock",
        title: "Vom Bienenstock lernen",
        text: "Die genaue Beobachtung zeigt, wie sich Bienenvölker organisieren, anpassen und zu widerstandsfähigen Ökosystemen beitragen.",
      },
      {
        src: "/associations1.jpeg",
        alt: "Vereinsmitglieder bei einer MOSA-Outdoor-Session",
        title: "Vereine am Energiepfad",
        text: "Vereine und Mitgliedergruppen erkunden Nachhaltigkeitsthemen an geführten Outdoor-Stationen.",
      },
      {
        src: "/associations2.jpeg",
        alt: "MOSA-Workshop mit Vereinstteilnehmenden",
        title: "Praxisnahes Lernen für Mitgliedergruppen",
        text: "Jugendvereine, NGOs und Bürgerinitiativen nehmen gemeinsam an Experimenten und Feldaktivitäten teil.",
      },
      {
        src: "/associations4.jpeg",
        alt: "Vereinsgruppe an einer MOSA-Station",
        title: "Gemeinsame Lernerlebnisse",
        text: "Organisatorinnen und Organisatoren verbinden Vereinsziele mit laufender Forschung am Zentrum.",
      },
    ],
  },
} as const;
